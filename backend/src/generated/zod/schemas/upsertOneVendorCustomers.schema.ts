...
export const VendorCustomersUpsertOneSchema: z.ZodType<Prisma.VendorCustomersUpsertArgs> = z.object({ select: VendorCustomersSelectObjectSchema.optional(), include: VendorCustomersIncludeObjectSchema.optional(), where: VendorCustomersWhereUniqueInputObjectSchema, create: z.union([ VendorCustomersCreateInputObjectSchema, VendorCustomersUncheckedCreateInputObjectSchema ]), update: z.union([ VendorCustomersUpdateInputObjectSchema, VendorCustomersUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.VendorCustomersUpsertArgs>;
