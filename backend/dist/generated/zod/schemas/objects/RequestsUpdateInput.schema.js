...
import { VendorCustomersUpdateOneRequiredWithoutRequestNestedInputObjectSchema as VendorCustomersUpdateOneRequiredWithoutRequestNestedInputObjectSchema } from './VendorCustomersUpdateOneRequiredWithoutRequestNestedInput.schema';
import { ProductUpdateOneRequiredWithoutRequestNestedInputObjectSchema as ProductUpdateOneRequiredWithoutRequestNestedInputObjectSchema } from './ProductUpdateOneRequiredWithoutRequestNestedInput.schema';
const makeSchema = () => z.object({
    ...
    vendorCustomers: z.lazy(() => VendorCustomersUpdateOneRequiredWithoutRequestNestedInputObjectSchema).optional(),
    product: z.lazy(() => ProductUpdateOneRequiredWithoutRequestNestedInputObjectSchema).optional()
}).strict();
export const RequestsUpdateInputObjectSchema = makeSchema();
