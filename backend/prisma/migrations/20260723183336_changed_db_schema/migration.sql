/*
  ...
  - Added the required column `subscriptionId` to the `Requests` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Requests" ADD COLUMN     "subscriptionId" TEXT NOT NULL,
DROP COLUMN "type",
